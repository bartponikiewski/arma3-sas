...
## Use when
- Editing or creating files in the `sas/` directory
...
5. **Registration**: Register public functions in the central include file (e.g., `sas/description.cpp`). Helpers remain internal.
...
This instruction enforces SAS framework standards for modularity, naming, documentation, and engine compatibility in Arma 3 mission scripting. Use for all work in the `sas/` directory.